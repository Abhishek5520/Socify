        ...
        <div className="loginWrapper">
            ...
            <div className="loginRight">
                <form className="loginBox" onSubmit={handleClick}>
                    ...
                    <button className="loginButton" type="submit" disabled={isFetching}>{isFetching ? <CircularProgress className="progress" size="20px" /> : "Log In"}</button>
                    <span className="loginForgot">Forgot Password ?</span>
                    <button className="loginRegisterButton">{isFetching ? <CircularProgress className="progress" size="20px" /> : "Create a New Account"}</button>
                </form>
            </div>
        </div>
    </div>
